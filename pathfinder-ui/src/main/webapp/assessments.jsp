					...
					"columnDefs": [
							...
							},
							{
								...
								"render": function (data,type,row){
									...
									var editUrl="<a href='survey.jsp?customerId="+ customerId +"&applicationId="+ row.Id +"&assessmentId="+ row.LatestAssessmentId +"'><span class='editLink'>(edit)</span></a>";
									...
									return "<span class='" + (row.Assessed ? "message"+color+"'>Yes " + completeIncomplete +editUrl : "messageRed'><a href='survey.jsp?customerId=" + customerId + "&applicationId=" + row.Id + "' class='messageRed'>No</a>") + "</span>"
								}
							},
							{
								"targets": 3,
