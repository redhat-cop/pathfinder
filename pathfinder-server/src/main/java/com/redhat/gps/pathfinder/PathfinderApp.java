...
import com.redhat.gps.pathfinder.config.ApplicationProperties;
import com.redhat.gps.pathfinder.config.DefaultProfileUtil;
...
public class PathfinderApp {
    ...
    public PathfinderApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PathfinderApp.class);
